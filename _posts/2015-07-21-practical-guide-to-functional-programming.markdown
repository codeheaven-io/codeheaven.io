...
author: rafaeleyng
excerpt: >
  Functional Programming lies somewhere between Computer Science and Mathmatics. It is a pretty dense and theoric subject, so the goal here is to show you how to start using some classic functions for collection manipulation in your everyday code.
---
